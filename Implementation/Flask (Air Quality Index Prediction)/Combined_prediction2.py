...
def combine(start_date,end_date):
    ...
    loaded_ann_model = load_model('D:/Works/Application of ML/Final/ANN_trained_model.h5')
    ...
    loaded_lstm_model = load_model('D:/Works/Application of ML/Final/LSTM_trained_model.h5', custom_objects={'mse': mse})
    ...
    scaler_LSTM = load('D:/Works/Application of ML/Final/scaler_LSTM.joblib')

    # Load the scaler for ANN
    scaler_ANN = load('D:/Works/Application of ML/Final/scaler_ANN.joblib')
    ...
    LSTM_cleaned_data = pd.read_csv('D:/Works/Application of ML/Final/LSTM_cleaned_data.csv')  # Load your original training data here
    LSTM_cleaned_data
    ...
    result_df.to_csv('D:/Works/Application of ML/Final/prediction_ANN.csv', index=False)
